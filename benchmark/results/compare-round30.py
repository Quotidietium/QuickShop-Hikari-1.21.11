#!/usr/bin/env python3
# R26 A/B comparison: round30-baseline (R25-closed HEAD ba3a3912e) vs round30
# (trade chain config sweep: reuse snapshots for pay-unlimited, notify tax, ShopUtil all-calc).
...
a, b = load("round30-baseline"), load("round30")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r30 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

#!/usr/bin/env python3
# R26 A/B comparison: round26-baseline (R25-closed HEAD 6586d2104) vs round26
# (chunk load fast gates: virtual-backend sweep skip + shop-less early return).
...
a, b = load("round26-baseline"), load("round26")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r26 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

#!/usr/bin/env python3
# R26 A/B comparison: round32-baseline (8f3633e6b parent 78eaacfd0) vs round32
# (listener+display config snapshot sweep).
...
a, b = load("round32-baseline"), load("round32")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'R32 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

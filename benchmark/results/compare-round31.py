#!/usr/bin/env python3
# R26 A/B comparison: round31-baseline (R25-closed HEAD 75fc6d02e) vs round31
# (startup loadShops: per-record join serialized pool -> aggregate allOf wait).
...
a, b = load("round31-baseline"), load("round31")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r31 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

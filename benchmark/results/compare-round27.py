#!/usr/bin/env python3
# R26 A/B comparison: round27-baseline (R25-closed HEAD ef8e0ca5d) vs round27
# (SignUpdateWatcher dedup: queue scan -> concurrent key set).
...
a, b = load("round27-baseline"), load("round27")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r27 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

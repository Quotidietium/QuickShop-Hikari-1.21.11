#!/usr/bin/env python3
# R26 A/B comparison: round29-baseline (R25-closed HEAD 4f688f9d8) vs round29
# (price chain: currency-symbol snapshot + ThreadLocal DecimalFormat).
...
a, b = load("round29-baseline"), load("round29")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r29 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

#!/usr/bin/env python3
# R26 A/B comparison: round31b-baseline (R25-closed HEAD 34ba5fb20) vs round31b
# (lang phase: built-in fallback parsed once instead of twice per load).
...
a, b = load("round31b-baseline"), load("round31b")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r31b ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

#!/usr/bin/env python3
# R26 A/B comparison: round33-baseline (log pipeline baseline eb0261560) vs round33
# (log pipeline zero-cost hot path).
...
a, b = load("round33-baseline"), load("round33")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'R33 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

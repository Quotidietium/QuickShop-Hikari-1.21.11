#!/usr/bin/env python3
# R26 A/B comparison: round28-baseline (R25-closed HEAD 0b72581e7) vs round28
# (misc hotpath composite: name-flag + chat-gate snapshots, holder single-resolve).
...
a, b = load("round28-baseline"), load("round28")
common = sorted(set(a) & set(b))
only_a, only_b = sorted(set(a) - set(b)), sorted(set(b) - set(a))

overlaps = []
print(f"{'case':40s} {'baseline ns/op':>15s} {'r28 ns/op':>15s} {'delta':>8s}   fork values (base | cand)")
for name in common:

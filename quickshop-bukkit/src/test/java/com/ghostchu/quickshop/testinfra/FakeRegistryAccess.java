package com.ghostchu.quickshop.testinfra;
 ...
 * in the test resources; never shipped.
 */
...
public final class FakeRegistryAccess implements RegistryAccess {
  ...
  private static final Object ITEM_TYPE = proxy(ItemType.class, FakeRegistryAccess::defaultAnswer);
  ...
  private static final Registry<?> EMPTY =
          (Registry<?>)proxy(Registry.class, FakeRegistryAccess::defaultAnswer);
  ...
  private static Object proxy(final Class<?> type, final InvocationHandler handler) {
    ...
    return Proxy.newProxyInstance(FakeRegistryAccess.class.getClassLoader(),
  ...
  private static Object defaultAnswer(final Object proxy, final Method method, final Object[] args) {
    ...
    return switch(method.getName()) {
      ...
      case "toString" -> "registry-test-proxy";
